"""Query transformation service for step-back prompting and HyDE."""
import logging
...
class QueryTransformer:
    """Transforms queries using step-back prompting and optional HyDE for broader retrieval."""
    ...
    async def generate_hyde(self, query: str) -> Optional[str]:
        ...
        try:
            ...
            if len(response) < 20:
                logger.info("HyDE response too short (%d chars), discarding", len(response))
                return None
